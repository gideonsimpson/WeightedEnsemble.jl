...
"""
function run_we(E₀::TE, B₀::TB, mutation!::FM, selection!::FS, rebin!::FR, n_we_steps::Int; n_save_iters = 1) where
...
* `n_save_iters = 1` - save the ensemble and bins every `n_save_iters` iterations.  Set `n_save_iters=n_we_steps` to only save the final values.
"""
function run_we(E₀::TE, mutation!::FM, selection!::FS, analysis!::FA, n_we_steps::Int; n_save_iters = 1) where
...
"""
function run_we_observables(E₀::TE, B₀::TB, mutation!::FM, selection!::FS, rebin!::FR, n_we_steps::Int, observables::Tuple{Vararg{<:Function,NO}}) where
...
* `observables` - Tuple of scalar observable functions for the ergodic average
"""
function run_we_observables(E₀::TE, mutation!::FM, selection!::FS, analysis!::FA, n_we_steps::Int, observables::Tuple{Vararg{<:Function,NO}}) where
